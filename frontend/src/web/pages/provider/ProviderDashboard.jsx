    ...
    <div className="max-w-5xl mx-auto w-full space-y-6 px-6 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-5 bg-white rounded-2xl border shadow-sm overflow-hidden transition-all duration-300">
          <div onClick={() => setIsProfileOpen(!isProfileOpen)} className="p-4 bg-neutral-50/70 border-b flex items-center justify-between cursor-pointer select-none">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="bg-white rounded-2xl border shadow-sm overflow-hidden transition-all duration-300">
            <div onClick={() => setIsActiveTasksOpen(!isActiveTasksOpen)} className="p-4 bg-neutral-50/70 border-b flex items-center justify-between cursor-pointer select-none">
              <h3 className="font-bold text-sm text-neutral-900 flex items-center space-x-2">
          ...
          <div className="bg-white rounded-2xl border shadow-sm overflow-hidden transition-all duration-300">
            <div onClick={() => setIsPoolOpen(!isPoolOpen)} className="p-4 bg-neutral-50/70 border-b flex items-center justify-between cursor-pointer select-none">
              <h3 className="font-bold text-sm text-neutral-900 flex items-center space-x-2">
